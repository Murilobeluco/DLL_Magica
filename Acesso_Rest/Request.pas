...
uses
  Request.Intf, Data.DB, REST.Client, REST.Response.Adapter, REST.Types,
  System.SysUtils, System.Classes, Response.Intf, System.JSON,
  REST.Authenticator.Basic, FireDAC.Comp.Client, IPPeerAPI, IpPeerClient;

type
  IRequest = Request.Intf.IRequest;

  IResponse = Response.Intf.IResponse;
...
begin
  ...
  FRESTResponseDataSetAdapter.NestedElementsDepth := 10;
